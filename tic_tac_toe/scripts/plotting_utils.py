...
class Plot:
    def __init__(self, title, xlabel="Number of Corresponding Objects", ylabel="Mean absolute difference (grams)", for_print=False):
        ...
        self.ax.set_title(title_string, fontsize=16, fontweight='bold', y=1.05)
    ...
    def plot_evaluations(self, series, means, confidences,
                         label):
        pp.errorbar(series, means, yerr=confidences, label=label, marker=self.markers.pop(), dashes=[5, 5], capsize=5)
